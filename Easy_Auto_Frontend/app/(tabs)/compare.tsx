...
const SAMPLE_COMPARISONS = [
  {
    ...
    right: { name: 'Mitsubishi Pajero', year: '2021', img: require('../../assets/images/nissangtr.jpg') },
  },
  {
    id: '2',
    left: { name: 'Toyota Hilux', year: '2022', img: require('../../assets/images/bluecar.jpeg') },
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <FlatList
        ...
        contentContainerStyle={{ paddingBottom: 0 }} // Remove extra white space at bottom
      />
    </SafeAreaView>
  );
}

...
const styles = StyleSheet.create({
    ...
    yearBadge: { position: 'absolute', bottom: 8, left: 8, backgroundColor: 'rgba(35, 92, 248, 0.9)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 5 },
    yearBadgeText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    verifiedBadge: { position: 'absolute', top: 8, left: 8, backgroundColor: '#059669', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 5, gap: 3 },
    ...
    filterModalContent: { backgroundColor: '#fff', borderTopLeftRadius: 5, borderTopRightRadius: 5, padding: 24, maxHeight: '90%' },
    ...
    priceInputWrap: { flex: 1, backgroundColor: '#F9FAFB', borderRadius: 5, paddingHorizontal: 12, borderWidth: 1, borderColor: '#E2E8F0' },
    priceInput: { height: 48, fontSize: 15, color: '#111827' },
    priceDivider: { width: 12, height: 1, backgroundColor: '#D1D5DB' },
    locationInputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9FAFB', borderRadius: 5, paddingHorizontal: 12, height: 52, borderWidth: 1, borderColor: '#E2E8F0' },
    locationInput: { flex: 1, marginLeft: 8, fontSize: 15 },
    modalFooter: { flexDirection: 'row', gap: 12, marginTop: 24, paddingBottom: 20 },
    resetButton: { flex: 1, height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: '#F3F4F6' },
    resetButtonText: { fontSize: 15, fontWeight: '600', color: '#4B5563' },
    applyButton: { flex: 2, height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: COLORS.primary },

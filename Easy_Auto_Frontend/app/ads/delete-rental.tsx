...
export default function DeleteRental() {
    ...
    const handleConfirmDelete = () => {
        Alert.alert(
            "Confirm Delete",
            "Are you sure you want to permanently delete this rental ad? This action cannot be undone.",
            [
    ...
    const performDelete = async () => {
        ...
        try {
            ...
            if (deleteRes.success) {
                Alert.alert("Deleted", "The rental ad has been permanently removed.");
        ...
        <View style={styles.safe}>
            ...
            <View style={styles.subHeaderWrap}>
                <View style={styles.subHeader}>
                    ...
                    <Text style={styles.subHeaderTitle}>Delete Rental Ad</Text>
                </View>
            </View>

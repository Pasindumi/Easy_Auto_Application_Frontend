    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f3f4f6' }}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cover} onLayout={(e) => setCoverWidth(e.nativeEvent.layout.width)}>
            ...
            <View style={styles.topActions}>
              <TouchableOpacity style={styles.iconButton}><Feather name="heart" size={18} color="#fff" /></TouchableOpacity>
              <TouchableOpacity style={styles.iconButton}><Feather name="share" size={18} color="#fff" /></TouchableOpacity>
            </View>
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="tag" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="truck" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="calendar" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="check-circle" size={14} color="#2563eb" /></View>
          ...
          <View style={styles.sectionBox}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="cpu" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="droplet" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="navigation" size={14} color="#2563eb" /></View>
            ...
            <View style={styles.infoRow}>
              <View style={styles.leftRow}>
                <View style={styles.iconChip}><Feather name="repeat" size={14} color="#2563eb" /></View>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.sellerRow, { justifyContent: 'space-between' }]}>
      ...
      <View style={styles.footer}>
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
          <TouchableOpacity style={styles.circleBtn} onPress={callSeller}><Feather name="phone" color="#2563eb" size={18} /></TouchableOpacity>
          <TouchableOpacity style={styles.circleBtn} onPress={messageSeller}><Feather name="message-circle" color="#2563eb" size={18} /></TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 16, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, marginTop: 12, width: 340, padding: 12 },
  ...
  timeText: { color: '#6b7280', fontSize: 10, fontWeight: '500' },
  ...
  thumb: { width: 96, height: 64, borderRadius: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E7EB', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4 },
  priceCard: { marginTop: 12, backgroundColor: '#EFF6FF', borderRadius: 14, paddingVertical: 16, paddingHorizontal: 16, borderWidth: 1, borderColor: '#D8E4FF', minHeight: 88 },
  price: { color: '#2563eb', fontWeight: '800', fontSize: 18 },
  badgeRow: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#fff', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 20, borderWidth: 1, borderColor: '#E5E7EB' },
  badgeText: { color: '#6b7280', fontSize: 13, fontWeight: '600' },
  viewsBadgeRow: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#fff', paddingVertical: 4, paddingHorizontal: 8, borderRadius: 16, borderWidth: 1, borderColor: '#E5E7EB' },
  viewsBadgeText: { color: '#6b7280', fontSize: 11, fontWeight: '500' },
  ...
  negotiableBadgeText: { color: '#2563eb', fontSize: 11, fontWeight: '600' },
  section: { marginTop: 12, backgroundColor: '#eff6ff', borderRadius: 12, padding: 12 },
  sectionBox: { marginTop: 12, backgroundColor: '#F1F5FE', borderRadius: 14, padding: 12, borderWidth: 1, borderColor: '#D8E4FF' },
  sectionHeader: { fontWeight: '700', color: '#1F2937', fontSize: 14 },
  sectionHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  infoRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, borderBottomWidth: 1, borderColor: '#E5E7EB', minHeight: 40 },
  leftRow: { flexDirection: 'row', alignItems: 'center', gap: 10, flexShrink: 0, width: 160 },
  iconChip: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#DBEAFE', alignItems: 'center', justifyContent: 'center' },
  fieldLabel: { color: '#374151', fontWeight: '600', marginLeft: 0 },
  infoValue: { flex: 1, fontWeight: '600', paddingLeft: 8, textAlign: 'right', color: '#111827' },
  description: { color: '#4b5563', fontSize: 13 },
  ...
  reportText: { color: '#EF4444', fontWeight: '600' },
  simList: { flexDirection: 'row', gap: 12, paddingTop: 8, paddingRight: 4 },
  simCard: { width: 164, borderRadius: 12, backgroundColor: '#fff', padding: 8, borderWidth: 1, borderColor: '#E5E7EB', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 6, elevation: 1 },
  ...
  simTitle: { fontWeight: '700', fontSize: 13, marginTop: 8, color: '#111827' },
  simPrice: { color: '#6b7280', fontSize: 12, marginTop: 2, fontWeight: '600' },
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, backgroundColor: '#fff', padding: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderTopWidth: 1, borderColor: '#E5E7EB' },
  contactBtn: { backgroundColor: '#2563eb', borderRadius: 10, paddingHorizontal: 20, paddingVertical: 12 },
  contactText: { color: '#fff', fontWeight: 'bold' },
  circleBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#EFF6FF', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#BFDBFE' },
});
